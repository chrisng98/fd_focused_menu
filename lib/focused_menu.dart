...
import 'package:fd_focused_menu/modals.dart';
...
class FocusedMenuDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final topOffset =
        (childOffset.dy + menuHeight + childSize!.height) < size.height - bottomOffsetHeight! ? childOffset.dy + childSize!.height + menuOffset! : childOffset.dy - menuHeight - menuOffset!;
    return Scaffold(
      ...
      body: Container(
        child: Stack(
          ...
          children: <Widget>[
            ...
            Positioned(top: childOffset.dy, left: childOffset.dx, child: AbsorbPointer(absorbing: true, child: Container(width: childSize!.width, height: childSize!.height, child: child))),
          ],
        ),
      ),
    );
